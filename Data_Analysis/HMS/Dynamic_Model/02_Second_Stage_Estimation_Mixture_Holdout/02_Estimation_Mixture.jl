...
if HPC
    ...
    output_dir = abspath(joinpath(@__DIR__, "Dynamic_Model_Mixture_Holdout_V2_$(psi_tag)_$(beta_tag)_$(psi_3_tag)_Results"))
    mkpath(output_dir)

    # Set working directory to where the holdout data CSVs live
    cd("/home/u2/wbrasic/4th_Year_Paper/Data_Holdout")
else

    # Output path for results (local Windows path)
    output_dir = "C:/Users/wbras/OneDrive/Documents/Desktop/UA/4th_Year_Paper/4th_Year_Paper_Data/HMS/2021-Onward/Dynamic_Model/Dynamic_Model_Mixture_Holdout_V2_$(psi_tag)_$(beta_tag)_$(psi_3_tag)_Results"
    mkpath(output_dir)
...
log_dir          = joinpath(output_dir, "Dynamic_Model_Mixture_Holdout_V2_$(psi_tag)_$(beta_tag)_$(psi_3_tag)_Log")
outer_try_dir    = joinpath(output_dir, "Dynamic_Model_Mixture_Holdout_V2_$(psi_tag)_$(beta_tag)_$(psi_3_tag)_Outer_Try_Params")
inner_try_dir    = joinpath(output_dir, "Dynamic_Model_Mixture_Holdout_V2_$(psi_tag)_$(beta_tag)_$(psi_3_tag)_Inner_Try_Params")
estimates_subdir = joinpath(output_dir, "Dynamic_Model_Mixture_Holdout_V2_$(psi_tag)_$(beta_tag)_$(psi_3_tag)_Estimates")
mkpath(log_dir)
...
log_path       = joinpath(log_dir, "Dynamic_Model_Mixture_Holdout_V2_$(psi_tag)_$(beta_tag)_$(psi_3_tag)_Log_$(run_id).txt")
outer_try_path = joinpath(outer_try_dir, "Dynamic_Model_Mixture_Holdout_V2_$(psi_tag)_$(beta_tag)_$(psi_3_tag)_Outer_Try_Params_$(run_id).csv")
inner_try_path = joinpath(inner_try_dir, "Dynamic_Model_Mixture_Holdout_V2_$(psi_tag)_$(beta_tag)_$(psi_3_tag)_Inner_Try_Params_$(run_id).csv")
...
#   ψ_1 = 0.10 and β = 1.0 are hardcoded above
ψ_2, _, _, δ = get_fixed_parameters();
...
estimates_path = joinpath(estimates_subdir, "Dynamic_Model_Mixture_Holdout_V2_$(psi_tag)_$(beta_tag)_$(psi_3_tag)_Estimates.csv")
...
stats_path = joinpath(estimates_subdir, "Dynamic_Model_Mixture_Holdout_V2_$(psi_tag)_$(beta_tag)_$(psi_3_tag)_Statistics.csv")
...
hh_ll_path = joinpath(estimates_subdir, "Dynamic_Model_Mixture_Holdout_V2_$(psi_tag)_$(beta_tag)_$(psi_3_tag)_HH_LL.csv")
