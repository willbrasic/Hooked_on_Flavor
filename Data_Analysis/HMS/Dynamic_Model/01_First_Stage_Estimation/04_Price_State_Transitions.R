...
file_name <- paste0("./Data/Pricing_Spaces.csv")
...
# First draws u_r ~ U(0, 1) from K prime bases, then applies the normal inverse CDF
# (normal = TRUE) to get z_r ~ N(0, I_K)
# With K = 2 categories, the prime base for cigs is 2 and for e-cigs is 3
...
file_name <- "../Dynamic_Model/Data/Halton_Draw_Shocks.csv"
