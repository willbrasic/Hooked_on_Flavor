...
# Write the data to a file
file_name <- "../Dynamic_Model/Data/Teen_Young_Adult.csv"
...
# Merge state-month median monthly prices
sm_cols <- setdiff(
...
# Merge monthly median monthly prices
...
# Create final price columns: ONE price per BIN per observation
...
# Only the final sample month should show b/c that's the only month
# where a lead is unavailable
