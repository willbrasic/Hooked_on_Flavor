...
# September 2025
#
# Monthly purchase frequencies of packs of cigarettes and mL of e-liquid
# for households with a teen or young adult
################################################################################
...
# Only consider TYA HHs
dt <- dt[teen_or_young_adult_present == 1]
...
# Write cig results
file_name_cig <- paste0(output_directory, "/A_02_Cig_Frequencies_TYA_Plot.txt")
fwrite(
  dt_cig_plot,
  file = file_name_cig,
  sep = " ",
...
# Write e-cig results
file_name_ecig <- paste0(output_directory, "/A_02_ECig_Frequencies_TYA_Plot.txt")
fwrite(
  dt_ecig_plot,
  file = file_name_ecig,
  sep = " ",
