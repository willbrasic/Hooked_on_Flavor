...
# September 2025
#
# Figure for flavored and unflavored e-cig purchase frequencies
...
# Build a 4-bar dataset: present vs absent for a given indicator
...
# Compute rates by indicator group
...
# Stack into one plotting table, ordered consistently
